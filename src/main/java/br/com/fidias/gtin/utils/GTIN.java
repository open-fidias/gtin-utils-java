...
import static br.com.fidias.gtin.utils.Internals.*;
...
public final class GTIN {
    ...
    /**
     * Returns the normal form for a GTIN by shortening it to its shortest
     * possible length and if it is a variable measure item normalizes it by
    ...
    public static List<String> allPossibleFormats(String gtin) {
        ...
        validateFormat(gtin);
        ArrayList<String> formats = new ArrayList<>(4);
