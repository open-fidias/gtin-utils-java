...
public class GTINTests {
    ...
    public void testIsValid() {
        ...
        assertTrue(GTIN.isValid("7891203050441"));
        assertTrue(GTIN.isValid("7891962018959"));
        assertTrue(GTIN.isValid("7891000023112"));
        assertTrue(GTIN.isValid("7891962015644"));
        assertTrue(GTIN.isValid("7896061300677"));
        assertTrue(GTIN.isValid("7891000012109"));
        assertTrue(GTIN.isValid("7891356009235"));
        assertTrue(GTIN.isValid("7896079441119"));
        assertTrue(GTIN.isValid("7891000049235"));

        assertFalse(GTIN.isValid("789100004923"));
    }
